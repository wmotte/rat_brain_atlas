...
rois.nii.gz            	PW atlas regions, bilateral (no discrimination between left/right).
rois.txt            	PW atlas region labels.

rois_bilateral.nii.gz   PW atlas regions, unilateral (discrimination between left/right).
rois_bilateral.txt      PW region, unilateral labels.
